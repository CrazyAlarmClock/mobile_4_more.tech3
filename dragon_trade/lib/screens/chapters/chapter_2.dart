    ...
    return Scaffold(
      ...
      children: [
        Padding(
          padding: const EdgeInsets.all(16.0),
          child: Text(
              '$value из ${UserData.gold==null?1000.0:UserData.gold<UserData.leprecons?(UserData.leprecons) :(UserData.gold)}',
              style: TextStyle(
                fontSize: 24,
      ...
      child: Slider(
          ...
          min:0+0.0,
          max:UserData.gold==null?1000.0:UserData.gold<UserData.leprecons?(UserData.leprecons+0.0) :(UserData.gold+0.0),
      )),
        )
