    ...
    Column(
      ...
      children: [
        Padding(
          padding: const EdgeInsets.all(16.0),
          child: Text(
              '$value из ${UserData.gold==null?1000.0:UserData.gold<UserData.witchers?(UserData.witchers) :(UserData.gold)}',
              style: TextStyle(
                fontSize: 24,
      ...
      child: Slider(
          ...
          min:0+0.0,
          max:UserData.gold==null?1000.0:UserData.gold<UserData.witchers?(UserData.witchers+0.0) :(UserData.gold+0.0),
      )),
        )
